...
function cptui_register_my_cpts() {
    $labels = array(
        ...
        "singular_name" => "Ардатовский район",
        "menu_name" => "Ардатовский район",
        "all_items" => "Ардатовский район",
        "add_new" => "Добавить",
    ...
    $args = array(
        "labels" => $labels,
        "hierarchical" => true,
        "supports" => array( "title", "editor", "comments", "revisions", "thumbnail", "author" ),
        "description" => "",
        "public" => true,
        "show_ui" => true,
        "has_archive" => true,
        ...
        "capability_type" => "ardatovskij-rajon",
        "map_meta_cap" => true,
        'show_in_nav_menus' => true,
        'publicly_queryable' => true,
        // 'rewrite' => true,
        "rewrite" => array( "slug" => "ardatovskij-rajon", "with_front" => true ),
        "query_var" => true,
        'can_export' => true,
        "menu_position" => 6,

    );
    register_post_type( "ardatovskij-rajon", $args );
